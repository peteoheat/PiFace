...
camera.framerate = 32
#camera.preview_fullscreeen = False
...
def deny_access():
    print ('[INFO] Entered ACCESS DENIED')
...
def factor_3(this_card_pin):
    ...
    print("[INFO] Look at the camera and I will take your picture in 3 seconds")
    sleep(3)
    print("[INFO] Taking your photo")
    stream.seek(0)
